...
rating_data_ <- read.csv("ratings.csv")
str(movie_data)
###
...
#creating a search matrix and rating matrix
...
#create table of ratings displaying MOST unique ratings
...
#building reccomendation system using R
...
#sum of rows and columns with the similarity of the objects above o. Visualize distribution
